...
Sou um profissional apaixonado por tecnologia, dados e gestão de pessoas, atuando na interseção entre Recursos Humanos, Business Intelligence e Automação de Processos.

Minha trajetória combina experiência operacional e estratégica em RH com o desenvolvimento de soluções tecnológicas capazes de transformar dados em decisões inteligentes.

Atualmente, dedico meus estudos e projetos ao desenvolvimento de dashboards analíticos, automação de processos, Inteligência Artificial aplicada aos negócios e soluções voltadas para People Analytics.
